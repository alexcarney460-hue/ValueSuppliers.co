...
const BENEFITS = [
  ...
  { icon: User, title: 'Custom Quotes', desc: 'Case-based quotes tailored to your order volume.' },
];
      ...
      >
        ...
        <AnimateIn style={{ maxWidth: 560, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.65)', marginBottom: 36, lineHeight: 1.75 }}>
            Distribution accounts get $56.60/case pricing (120+ cases) with priority allocation and a dedicated rep.
          </p>
          <Link
            href="/distribution"
            style={{
