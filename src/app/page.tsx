...
const TIER_CARDS = [
  {
    ...
    description: '$80/case. Order 1–29 cases at retail pricing — no application needed.',
    cta: 'Shop Now',
    href: '/catalog',
  },
  {
    ...
    description: '$70/case on 30+ case orders. Save $10/case with fast restock for hydro stores, dispensaries, and grows.',
  ...
  },
  {
    ...
    description: '$56.60/case on 120+ case orders. Save $23.40/case with a dedicated rep and priority allocation.',
