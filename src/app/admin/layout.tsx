        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <a
            ...
            style={{
              ...
              fontSize: '0.8rem',
              color: '#fff',
              backgroundColor: 'var(--color-forest, #2d5016)',
              textDecoration: 'none',
            }}
          >
            Sign in
    ...
    <div className="fixed inset-0 overflow-auto" style={{ background: 'var(--bg, #f8f8f6)', zIndex: 200 }}>
      ...
      >
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', height: 56, gap: 24, overflowX: 'auto' }}>
          <Link
            href="/admin"
            style={{ fontWeight: 900, fontSize: '1.1rem', whiteSpace: 'nowrap', flexShrink: 0, color: 'var(--color-forest, #2d5016)', textDecoration: 'none' }}
          >
            VS Admin
          </Link>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    background: active ? 'var(--color-forest, #2d5016)' : 'transparent',
