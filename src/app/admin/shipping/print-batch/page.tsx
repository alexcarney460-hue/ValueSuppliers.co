...
export default function PrintBatchPage() {
  ...
  const btnPrimary: React.CSSProperties = {
    ...btnBase,
    backgroundColor: 'var(--color-forest, #1b3a2d)',
    color: '#fff',
    border: 'none',
    fontWeight: 700,
  };
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${isSelected ? '#1b3a2d' : 'var(--color-border, #e4e1db)'}`,
        borderRadius: 10,
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
          ...
          {order.shipping_carrier && (
            <span style={{
              fontSize: '0.72rem', fontWeight: 700, color: '#1b3a2d',
