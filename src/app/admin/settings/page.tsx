...
const PRICING_TIERS = [
  { name: 'Retail', discount: '$80/case', label: '1–29 cases', color: '#1B3A2D', minOrder: '1 case' },
  { name: 'Wholesale', discount: '$70/case', label: 'Save $10/case', color: '#C8922A', minOrder: '30 cases' },
  { name: 'Distribution', discount: '$56.60/case', label: 'Save $23.40/case', color: '#1C1C1C', minOrder: '120 cases' },
];
      ...
      <section style={{ marginBottom: 48 }}>
        ...
        <p style={{ color: 'var(--color-warm-gray)', fontSize: '0.82rem', marginBottom: 20 }}>
          ...
          {productsSource === 'static' && (
            <span style={{ marginLeft: 8, color: '#C8922A', fontWeight: 600 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 180 }}>
                      ...
                      <div style={{ fontSize: '0.78rem', color: 'var(--color-warm-gray)', marginTop: 2 }}>
                        {p.category}
                        {p.badge && (
                          <span style={{ marginLeft: 8, padding: '2px 8px', borderRadius: 9999, background: 'var(--color-forest)', color: '#fff', fontSize: '0.7rem', fontWeight: 600 }}>
                            {p.badge}
                          </span>
                        )}
                      </div>
                ...
                {isEditing && (
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: 10 }}>
                      <button onClick={saveEdit} disabled={saving} style={{ padding: '8px 22px', borderRadius: 9999, border: 'none', background: 'var(--color-forest)', color: '#fff', fontWeight: 700, fontSize: '0.82rem', cursor: saving ? 'not-allowed' : 'pointer', opacity: saving ? 0.6 : 1 }}>
            ...
            {([
              ...
              <div key={flag.key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid var(--color-border)' }}>
                ...
                <button
                  ...
                  style={{ position: 'relative', width: 44, height: 24, borderRadius: 9999, border: 'none', cursor: 'pointer', flexShrink: 0, background: features[flag.key] ? 'var(--color-forest)' : '#ccc', transition: 'background 200ms' }}
                >
