          ...
          >
            <div
              style={{
                ...
                background: d.views > 0 ? 'var(--color-forest, #1B3A2D)' : 'var(--color-border, #E4E1DB)',
...
function RankedList({ items, color = 'var(--color-forest, #1B3A2D)' }: { items: { label: string; count: number }[]; color?: string }) {
