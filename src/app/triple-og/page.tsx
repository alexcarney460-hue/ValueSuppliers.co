...
export default function TripleOGPage() {
  return (
    <div style={{ paddingTop: 'var(--nav-height)', backgroundColor: '#0A0A0A' }}>
      ...
      {/* ── MARQUEE ── */}
      <div
        style={{ backgroundColor: 'var(--color-amber)', padding: '12px 0', overflow: 'hidden' }}
          ...
          <div style={{ position: 'relative' }} className="vs-hero-image-col">
            ...
            <div className="vs-float" style={{ position: 'relative', zIndex: 1 }}>
              ...
              >
                ...
                >
                  <BadgeCheck size={18} color="var(--color-amber)" />
                </div>
                <div>
        ...
        >
          {SOCIAL_PROOF.map((item) => (
            <div key={item.label} style={{ textAlign: 'center' }}>
              <div
                className="font-mono"
                style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-amber)', lineHeight: 1 }}
              >
                {item.stat}
              </div>
      ...
      <section style={{ backgroundColor: '#111', padding: '96px 24px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <AnimateIn style={{ textAlign: 'center', marginBottom: 64 }}>
            <span className="label-caps" style={{ color: 'var(--color-amber)', fontSize: '0.72rem' }}>
              Why Triple OG
            </span>
            <h2
      ...
      <section style={{ backgroundColor: '#0A0A0A', padding: '96px 24px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }} className="vs-hero-grid">
          <AnimateIn>
              ...
              <AnimateIn key={tier} delay={i * 100}>
                <Link href={href} style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
                  <div
                    ...
                    style={{
                      backgroundColor: '#1a1a1a',
                      border: tier === 'Distribution' ? '2px solid var(--color-amber)' : '1px solid rgba(255,255,255,0.06)',
                      borderRadius: 20,
                      padding: '36px 28px',
                      height: '100%',
                      display: 'flex',
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        color: tier === 'Distribution' ? 'var(--color-amber)' : 'rgba(255,255,255,0.5)',
                        fontSize: '0.72rem',
                        display: 'inline-flex',
                        alignItems: 'center',
                        gap: 6,
      ...
      >
        ...
        <AnimateIn style={{ maxWidth: 640, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <span className="label-caps" style={{ color: 'var(--color-amber)', display: 'block', marginBottom: 20, fontSize: '0.72rem' }}>
            Supplied by ValueSuppliers.co
          </span>
          <h2
            className="font-display"
