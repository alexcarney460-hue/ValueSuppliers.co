...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://valuesuppliers.co/affiliate',
  },
  alternates: { canonical: 'https://valuesuppliers.co/affiliate' },
};
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a
              ...
              style={{
                ...
                textDecoration: 'none', boxShadow: 'var(--shadow-amber)',
              }}
            >
        ...
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <AnimateIn style={{ marginBottom: 52 }}>
            <h2 className="font-display" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--color-charcoal)', textAlign: 'center' }}>
              Why Partner with ValueSuppliers.co
            </h2>
          </AnimateIn>
            ...
            {[
              ...
              <AnimateIn key={title} delay={i * 70}>
                <div style={{ display: 'flex', gap: 14 }}>
                  <div style={{ color: 'var(--color-amber)', fontWeight: 800, fontSize: '1.1rem', flexShrink: 0, paddingTop: 2 }}>✓</div>
                  <div>
      ...
      <section style={{ backgroundColor: '#fff', borderBottom: '1px solid var(--color-border)', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <AnimateIn style={{ textAlign: 'center', marginBottom: 16 }}>
            <span className="label-caps" style={{ color: 'var(--color-amber)' }}>Commission Tiers</span>
              ...
              <AnimateIn key={name} delay={i * 70}>
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 20,
                    padding: '28px 20px',
                    border: highlighted ? '2px solid var(--color-amber)' : '1px solid var(--color-border)',
                    boxShadow: highlighted ? 'var(--shadow-amber)' : 'var(--shadow-xs)',
                    height: '100%',
                  }}
                >
                  <div className="font-display" style={{ fontSize: '2.25rem', color: 'var(--color-amber)', lineHeight: 1, marginBottom: 6 }}>{rate}</div>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 6 }}>
                    {perks.map((perk) => (
                      <li key={perk} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: '0.78rem', color: perk.includes('NET-7') ? 'var(--color-amber)' : 'var(--color-warm-gray)', fontWeight: perk.includes('NET-7') ? 700 : 400 }}>
                        <span style={{ color: 'var(--color-amber)', fontSize: '0.7rem' }}>✓</span> {perk}
                      </li>
                    ))}
                  </ul>
                </div>
      ...
      <section style={{ backgroundColor: '#FAFAFA', borderBottom: '1px solid var(--color-border)', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <AnimateIn style={{ textAlign: 'center', marginBottom: 52 }}>
            <span className="label-caps" style={{ color: 'var(--color-amber)' }}>Partner Tools</span>
            <h2 className="font-display" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', marginTop: 10, color: 'var(--color-charcoal)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 12 }}>
            {WHO.map((item, i) => (
              <AnimateIn key={item} delay={i * 80}>
                ...
                >
                  <span style={{ color: 'var(--color-amber)', fontWeight: 800, fontSize: '1rem' }}>→</span>
                ...
                <div>
                  ...
                  {contact ? (
                    <p style={{ fontSize: '0.9rem', color: 'var(--color-warm-gray)', lineHeight: 1.7 }}>
                      ...
                      <a href="mailto:partners@valuesuppliers.co" style={{ color: 'var(--color-amber)', fontWeight: 700, textDecoration: 'none' }}>
                        partners@valuesuppliers.co
                      </a>
                    </p>
                  ) : (
