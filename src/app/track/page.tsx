...
const STATUS_MAP: Record<string, { label: string; color: string; bg: string; icon: typeof Package }> = {
  ...
  processing: { label: 'Processing', color: 'var(--color-amber)',    bg: 'rgba(200,146,42,0.10)',  icon: Box },
  shipped:    { label: 'Shipped',    color: 'var(--color-forest)',   bg: 'rgba(62,85,55,0.10)',    icon: Truck },
  delivered:  { label: 'Delivered',  color: 'var(--color-forest)',   bg: 'rgba(62,85,55,0.10)',    icon: CheckCircle2 },
    ...
    <div style={{ paddingTop: 'var(--nav-height)', backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          >
            <span style={{ width: 24, height: 1.5, backgroundColor: 'var(--color-forest)', display: 'inline-block', borderRadius: 99 }} />
            Order Tracking
            <span style={{ width: 24, height: 1.5, backgroundColor: 'var(--color-forest)', display: 'inline-block', borderRadius: 99 }} />
          </span>
          <h1
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: 'none',
                backgroundColor: loading ? 'var(--color-warm-gray)' : 'var(--color-forest)',
                color: '#fff',
                fontFamily: "'Barlow', Arial, sans-serif",
                fontWeight: 700,
                fontSize: '0.82rem',
              ...
              onMouseEnter={(e) => {
                if (!loading) {
                  (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'var(--color-forest-light)';
                ...
                >
                  <p style={{ color: 'var(--color-warm-gray)', fontSize: '0.82rem', lineHeight: 1.6 }}>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: 'var(--color-forest)', textDecoration: 'underline', fontWeight: 600 }}
                    >
                      {order.tracking_url}
                    </a>
                  </p>
        ...
        <AnimateIn delay={200}>
          ...
          >
            ...
            <Link
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.borderColor = 'var(--color-forest)';
                (e.currentTarget as HTMLAnchorElement).style.backgroundColor = 'var(--color-sage-light)';
              }}
              onMouseLeave={(e) => {
