        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ color: '#fff', fontWeight: 700, fontSize: '0.85rem', lineHeight: 1 }}>ValueSuppliers</div>
              ...
              >
                <div
                  style={{
                    ...
                    backgroundColor: msg.role === 'user' ? 'var(--color-forest)' : '#fff',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 36,
                borderRadius: '50%',
                backgroundColor: input.trim() && !isLoading ? 'var(--color-amber)' : 'var(--color-border)',
                border: 'none',
