      ...
      {({ values, onChange, status }) => (
        <>
          ...
          <button type="submit" disabled={status === 'submitting'} style={{
            backgroundColor: 'var(--color-amber)', color: '#fff', border: 'none', borderRadius: 9999,
            ...
            boxShadow: 'var(--shadow-amber)', opacity: status === 'submitting' ? 0.6 : 1,
          }}>
          ...
          <p style={{ textAlign: 'center', fontSize: '0.78rem', color: 'var(--color-warm-gray)' }}>
            ...
            <a href="/contact" style={{ color: 'var(--color-forest)' }}>Terms of Service</a>.
